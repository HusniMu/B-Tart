...
<div class="container-fluid">
    <div class="block-header">
        <a href="{{route('admin.topping.create')}}" class="btn btn-primary waves-effect">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header">
                    <h2>
                        ALL TOPPINGS
                        <span class="badge bg-info">{{$toppings->count()}}</span>
                    </h2>
                </div>
                <div class="body">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <button class="btn btn-danger waves-effect" type="button">
                                            <i class="material-icons" onclick="deleteTopping({{$topping->id}})">delete</i>
                                        </button>
                                        <form id="delete-form-{{$topping->id}}"
                                            action="{{route('admin.topping.destroy',$topping->id)}}" method="POST"
                                            style="display: none;">
                                            @csrf
                                            @method('DELETE')
                                        </form>
