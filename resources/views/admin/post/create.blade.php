            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <div class="body">
                        ...
                        <div class="form-group form-float">
                            <div class="form-line">
                                <input type="number" id="lama" name="lama" class="form-control" value="{{old('lama')}}"
                                    autofocus autocomplete="off">
                        ...
                        <div class="form-group">
                            ...
                            <label for="publish">Available</label>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="body">
                        <div class="form-group form-float">
                            <div class="form-line {{$errors->has('category') ? 'focused error' : ''}}">
                                ...
                                <select class="form-control show-tick" id="tag" name="category" data-live-search="true">
                    ...
                    <div class="body">
                        <div class="form-group form-float">
                            <div class="form-line {{$errors->has('hiasans') ? 'focused error' : ''}}">
                                <label for="hiasan">Select Hiasans</label>
